...
def main():
    ...
    while running:
        ...
        # Check for menu/reset, (key up event - trigger ONCE)
...
# initialization
pygame.init()
pygame.mixer.init() # initial sound -------------------

s='sound'
sound=pygame.mixer.music.load("./media/Action-Rock.ogg")
...
################# Project ##########################333
################### by ################################
################# Arman Sajedi #########################_____________________________________________
#########################################################
#####################################################
